...
function FacebookIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path
        d="M9.322 15.333V8.5H11.531L11.862 5.833H9.322V4.132C9.322 3.359 9.538 2.833 10.645 2.833H11.95V0.459C11.726 0.43 10.956 0.361 10.06 0.361C8.189 0.361 6.908 1.504 6.908 3.603V5.833H4.667V8.5H6.908V15.333H9.322Z"
        fill="currentColor"
      />
    </svg>
  );
...
function SocialIcon({ platform }: { platform: CommunityHeroSocialLink["platform"] }) {
...
const CommunityHero = ({ data }: CommunityHeroProps) => {
  return (
    ...
    >
      ...
      <div className="absolute right-12 top-1/2 z-20 hidden h-[400px] w-[40px] -translate-y-1/2 flex-col items-center justify-center gap-[15px] md:flex">
