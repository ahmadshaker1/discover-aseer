...
const FilmServicesSection = ({ cards }: FilmServicesSectionProps) => {
  return (
    <section
      className="mx-auto h-auto w-full max-w-[1442px] p-[60px]"
      dir="ltr"
    >
      <div className="mx-auto flex w-full max-w-[1322px] flex-col gap-16">
        ...
        <div
          className="flex h-auto w-full flex-col justify-between gap-4 lg:h-[290px] lg:flex-row"
          dir="rtl"
        >
          {cards.slice(0, 3).map((card) => (
            ...
            >
              <div
                className="flex h-[73.026314px] w-[73.026314px] items-center justify-center self-start rounded-full border border-[#E8E8E8] bg-white"
                dir="rtl"
              >
              ...
              <div
                className="flex w-full max-w-[370.666687px] flex-col gap-3 text-right"
                dir="rtl"
              >
                <h3
                  dir="rtl"
