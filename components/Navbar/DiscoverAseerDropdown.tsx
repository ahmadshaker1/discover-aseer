...
const DiscoverAseerDropdown = ({ label }: DiscoverAseerDropdownProps) => {
  return (
    <Menu as="div" className="relative">
      ...
      >
        <Menu.Items className="absolute left-0 mt-2 w-56 origin-top-left rounded-2xl bg-gradient-to-b from-[#191919]/95 via-[#2a1a3d]/95 to-[#1a2a1a]/95 backdrop-blur-xl border border-white/20 shadow-xl overflow-hidden z-50">
          <div className="py-2">
