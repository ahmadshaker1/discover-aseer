...
const ClockIcon = ({ className = filterSectionIconClass }: FilterIconProps) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
const PriceIcon = ({ className = filterSectionIconClass }: FilterIconProps) => (
  <svg
    width="20"
    height="20"
    viewBox="0 0 20 20"
...
const PeopleIcon = ({ className = filterSectionIconClass }: FilterIconProps) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    aria-hidden
  >
    <g clipPath="url(#lm_filter_people)">
      <path
...
const HeartIcon = ({ className = filterSectionIconClass }: FilterIconProps) => (
  <svg
    ...
    aria-hidden
  >
    <g clipPath="url(#lm_filter_heart)">
      <path
...
const LocationIcon = ({ className = filterControlIconClass }: FilterIconProps) => (
  <svg
    width="20"
    height="20"
    viewBox="0 0 20 20"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 8.75C10.6904 8.75 11.25 8.19036 11.25 7.5C11.25 6.80964 10.6904 6.25 10 6.25C9.30964 6.25 8.75 6.80964 8.75 7.5C8.75 8.19036 9.30964 8.75 10 8.75Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 17.5C9 17.5 3.75 13.2486 3.75 8.80274C3.75 5.3222 6.54758 2.5 10 2.5C13.4516 2.5 16.25 5.3222 16.25 8.80274C16.25 13.2486 10.9983 17.5 10 17.5Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ChevronDownIcon = ({ className = filterControlIconClass }: FilterIconProps) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
