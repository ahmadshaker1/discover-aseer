...
const welcomeCards = [
  ...
  {
    title: "الفعاليات و المواسم ",
    href: "/events",
    image: "/assets/landing/fireworks.jpg",
  },
  {
    title: "التجارب",
    href: "/experiences",
      ...
      <div className="mx-auto flex w-full max-w-[1180px] flex-col items-center gap-12 md:gap-[48px]">
        <div className="flex w-full flex-col items-center gap-[50px]">
          ...
          <p
            ...
            style={{ fontFamily: ara }}
          >
            في ثنائيات من البهاء؛ تلتقي قمم الجبال مع لؤلؤ الشطآن الصافية، وتصافح الرمال الذهبية
            الهضاب الخضراء. طبيعة يتماهى فيها المطر مع دفء السهول، ويختال فيها الضباب مع شموخ
            المكان.
          </p>
        </div>
