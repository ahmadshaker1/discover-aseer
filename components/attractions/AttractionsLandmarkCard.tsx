  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="absolute top-3 end-3 z-30 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-foreground backdrop-blur-[3.5px] data-focus:outline-none data-focus:ring-2 data-focus:ring-white/80 data-focus:ring-offset-2 data-focus:ring-offset-black/20"
      >
        <ShareIcon />
      </Button>
