      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 md:px-[60px]">
        ...
        <div className="mx-auto grid w-full max-w-[1320px] grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {landmarks.slice(0, 8).map((landmark) => (
            <article
              key={landmark.id}
              className="relative h-[419px] w-full overflow-hidden rounded-[10px] bg-black shadow-[0_4.28px_3.37px_0_rgba(41,72,152,0.01),0_8.72px_6.97px_0_rgba(41,72,152,0.02),0_21.4px_13.91px_0_rgba(41,72,152,0.02)]"
            >
              ...
              <div className="absolute right-3 top-3 inline-flex h-7 items-center justify-center rounded-[20px] bg-[#000000AD] px-3 py-1">
                <span
                  className="text-right text-[12px] font-medium leading-[100%] text-white"
              ...
              <div className="absolute bottom-0 left-0 right-0 flex h-[155px] flex-col gap-5 bg-linear-to-b from-transparent to-black p-5 text-white">
                ...
                <div className="flex max-w-[251px] flex-col gap-[18px]">
