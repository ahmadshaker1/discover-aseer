...
function FacebookIcon() {
  return (
    ...
    >
      <path
        d="M9.824 16H6.556v-7.39H4.89V5.811h1.665V4.11c0-2.31 1.054-3.57 3.518-3.57.94 0 1.942.167 1.942.167v2.13h-1.092c-1.146 0-1.503.712-1.503 1.44v1.534h2.4l-.384 2.799H9.824V16Z"
        fill="currentColor"
      />
    </svg>
  );
