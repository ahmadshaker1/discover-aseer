  ...
  return (
    <div className="flex min-w-0 w-full flex-col lg:flex-1">
      <div
        ref={scrollerRef}
        dir={scrollDir}
        className={`relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 overflow-x-auto scroll-smooth lg:left-0 lg:min-w-0 lg:w-full lg:max-w-none lg:shrink-0 lg:translate-x-0 ${TRACK_PAD}`}
      >
