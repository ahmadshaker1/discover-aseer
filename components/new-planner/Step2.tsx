...
export default function Step2({ onPrev, plannerData }: Step2Props) {
      ...
      <div className="container mx-auto px-6 max-w-[800px] flex flex-col items-start">
        ...
        <div className="bg-white dark:bg-[#1C0F2A] p-6 rounded-xl shadow-md w-full mb-8 border border-[rgba(0,0,0,0.1)] dark:border-white/20">
          <p className="text-lg text-black dark:text-white mb-2">
            <strong>Selected Days:</strong> {plannerData.selectedDays ?? "None"}
          </p>
          <p className="text-lg text-black dark:text-white">
            <strong>Selected Date:</strong>{" "}
            {plannerData.selectedDate
              ? plannerData.selectedDate.toLocaleDateString()
              : "None"}
          </p>
        </div>
